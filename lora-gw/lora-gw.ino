...
uint32_t global_radio_err_crc = 0;       // RadioLib error -2 (RADIOLIB_ERR_CRC_MISMATCH)
uint32_t global_radio_err_header = 0;    // RadioLib error -3 (RADIOLIB_ERR_LORA_HEADER_DAMAGE)
uint32_t global_radio_err_timeout = 0;   // RadioLib error -4 (RADIOLIB_ERR_RX_TIMEOUT)
