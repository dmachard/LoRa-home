...
uint32_t global_radio_err_crc = 0;       // RadioLib error -7 (RADIOLIB_ERR_CRC_MISMATCH)
uint32_t global_radio_err_header = 0;    // RadioLib error -3 (RADIOLIB_ERR_LORA_HEADER_DAMAGED)
uint32_t global_radio_err_timeout = 0;   // RadioLib error -6 (RADIOLIB_ERR_RX_TIMEOUT)
uint32_t global_radio_err_other = 0;     // Other RadioLib errors
uint32_t global_valid_packets = 0;
uint32_t global_ack_sent_total = 0;
