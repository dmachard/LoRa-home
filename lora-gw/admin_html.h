...
const formatFreq = (f) => parseFloat(f || 433.0).toFixed(1);
...
document.getElementById('lora_freq').value = parseFloat(json.lora_freq || 433.0).toFixed(1);
