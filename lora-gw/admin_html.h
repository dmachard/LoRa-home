...
tab_gw_config: "Gateway Configuration",
...
fr: {
admin_title: "Administration Passerelle",
...
tab_gw_config: "Configuration Passerelle",
...
document.getElementById('gw_lora_freq').value = json.lora_freq || 433.0;
