...
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Administration - LoRa Gateway</title> <style>@import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&display=swap');body{font-family:'Plus Jakarta Sans',system-ui,-apple-system,sans-serif;background:radial-gradient(circle at 50% 0%,#111827 0%,#030712 100%);color:#f8fafc;margin:0;padding:24px;min-height:100vh;}.container{max-width:1200px;margin:0 auto;}header{display:flex;justify-content:space-between;align-items:center;margin-bottom:32px;border-bottom:1px solid rgba(255,255,255,0.05);padding-bottom:20px;}h1{font-size:26px;font-weight:800;letter-spacing:-0.02em;background:linear-gradient(135deg,#ffffff 0%,#cbd5e1 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;margin:0;}.gw-stats{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:20px;margin-bottom:32px;}.stat-card{background:rgba(30,41,59,0.4);backdrop-filter:blur(16px);border:1px solid rgba(255,255,255,0.05);border-radius:16px;padding:24px;display:flex;flex-direction:column;box-shadow:0 4px 20px rgba(0,0,0,0.15);}.gw-stat-card{background:rgba(17,24,39,0.4);backdrop-filter:blur(24px);border:1px solid rgba(255,255,255,0.05);border-radius:16px;padding:16px 20px;display:flex;align-items:center;justify-content:space-between;box-shadow:0 10px 25px -5px rgba(0,0,0,0.3);}.stat-info{display:flex;flex-direction:column;}.stat-val{font-size:22px;font-weight:800;color:#ffffff;margin-top:2px;letter-spacing:-0.01em;}.stat-label{font-size:10px;color:#64748b;text-transform:uppercase;letter-spacing:0.08em;font-weight:700;}.wifi-signal-wrapper{display:flex;align-items:center;gap:12px;}.signal-bars{display:flex;align-items:flex-end;gap:3px;height:18px;}.signal-bar{width:4px;background:rgba(255,255,255,0.15);border-radius:2px;}.signal-bar.active{background:#38bdf8;}.signal-bar:nth-child(1){height:30%;}.signal-bar:nth-child(2){height:50%;}.signal-bar:nth-child(3){height:70%;}.signal-bar:nth-child(4){height:100%;}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(360px,1fr));gap:28px;}.node-card{background:rgba(17,24,39,0.45);backdrop-filter:blur(24px);border:1px solid var(--card-border,rgba(255,255,255,0.08));border-radius:20px;padding:24px;box-shadow:0 20px 40px -15px rgba(0,0,0,0.4);transition:all 0.3s cubic-bezier(0.4,0,0.2,1);display:flex;flex-direction:column;position:relative;overflow:hidden;}.node-card:hover{transform:translateY(-4px);border-color:var(--card-border-hover,rgba(255,255,255,0.15));box-shadow:0 25px 50px -12px var(--card-glow,rgba(255,255,255,0.02));}.node-card.offline{border-color:rgba(239,68,68,0.15);background:rgba(17,24,39,0.25);opacity:0.65;}.node-card.offline:hover{border-color:rgba(239,68,68,0.35);box-shadow:0 25px 50px -12px rgba(239,68,68,0.08);opacity:0.85;}.node-card.warning{border-color:rgba(245,158,11,0.18);}.node-card.warning:hover{border-color:rgba(245,158,11,0.4);box-shadow:0 25px 50px -12px rgba(245,158,11,0.12);}.node-header{display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;}.node-title-group{display:flex;flex-direction:column;}.node-name{font-size:20px;font-weight:800;color:#ffffff;letter-spacing:-0.02em;}.node-meta{font-size:11px;color:#64748b;margin-top:2px;font-weight:500;text-transform:uppercase;letter-spacing:0.05em;}.node-badge{padding:4px 12px;border-radius:9999px;font-size:10px;font-weight:700;letter-spacing:0.05em;text-transform:uppercase;border:1px solid transparent;}.node-readings{display:flex;flex-wrap:wrap;gap:28px;padding:20px 0;border-top:1px solid rgba(255,255,255,0.05);margin-bottom:16px;}.metric-item{display:flex;flex-direction:column;gap:4px;min-width:105px;}.metric-value-wrapper{display:flex;align-items:center;gap:8px;}.metric-icon{width:18px;height:18px;flex-shrink:0;}.metric-icon.temp{color:#f43f5e;}.metric-icon.hum{color:#38bdf8;}.metric-icon.press{color:#a855f7;}.metric-icon.light{color:#eab308;}.metric-icon.batt{color:#10b981;}.metric-value{font-size:22px;font-weight:800;color:#f8fafc;letter-spacing:-0.02em;}.metric-unit{font-size:13px;color:#64748b;margin-left:1px;font-weight:600;}.metric-label{font-size:10px;color:#64748b;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;}.node-footer{display:flex;justify-content:space-between;align-items:flex-end;font-size:11px;color:#64748b;margin-top:auto;padding-top:12px;border-top:1px solid rgba(255,255,255,0.04);}.node-footer-left,.node-footer-right{display:flex;flex-direction:column;gap:6px;}.node-footer-right{align-items:flex-end;}.footer-metric{display:flex;align-items:center;gap:4px;}.footer-metric b{color:#cbd5e1;}.footer-metric.right-aligned{justify-content:flex-end;}.status-indicator.right-aligned{justify-content:flex-end;}.node-radio-icon{width:14px;height:14px;color:#64748b;}.stat-divider{color:rgba(255,255,255,0.08);font-weight:bold;}.radio-badge{font-size:8px;font-weight:700;padding:1px 5px;border-radius:4px;text-transform:uppercase;letter-spacing:0.03em;margin-left:6px;display:inline-block;}.radio-badge.rssi-strong,.radio-badge.snr-clean{background:rgba(16,185,129,0.1);color:#34d399;border:1px solid rgba(16,185,129,0.15);}.radio-badge.rssi-medium,.radio-badge.snr-noisy{background:rgba(245,158,11,0.1);color:#fbbf24;border:1px solid rgba(245,158,11,0.15);}.radio-badge.rssi-weak,.radio-badge.snr-poor{background:rgba(239,68,68,0.1);color:#f87171;border:1px solid rgba(239,68,68,0.15);}.status-indicator{display:flex;align-items:center;gap:8px;}.dot{width:8px;height:8px;border-radius:50%;background:#10b981;box-shadow:0 0 10px rgba(16,185,129,0.8);position:relative;}.dot::after{content:'';position:absolute;top:0;left:0;width:100%;height:100%;border-radius:50%;background:inherit;animation:dot-pulse 1.8s infinite ease-in-out;}.dot.offline{background:#ef4444;box-shadow:0 0 10px rgba(239,68,68,0.8);}.dot.warning{background:#f59e0b;box-shadow:0 0 10px rgba(245,158,11,0.8);}@keyframes dot-pulse{0%{transform:scale(1);opacity:0.8;}100%{transform:scale(2.4);opacity:0;}}.status-text-on{color:#10b981;font-weight:600;}.status-text-warning{color:#f59e0b;font-weight:600;}.status-text-off{color:#ef4444;font-weight:600;}.btn-update{background:linear-gradient(135deg,#ef4444 0%,#dc2626 100%);color:white;border:none;padding:9px 18px;border-radius:10px;font-weight:700;text-decoration:none;font-size:13px;transition:all 0.2s;box-shadow:0 4px 12px rgba(239,68,68,0.2);}.btn-update:hover{transform:translateY(-1px);box-shadow:0 6px 16px rgba(239,68,68,0.3);}.btn-metrics{background:rgba(255,255,255,0.05);color:#94a3b8;border:1px solid rgba(255,255,255,0.08);padding:9px 18px;border-radius:10px;font-weight:700;text-decoration:none;font-size:13px;margin-right:8px;transition:all 0.2s;}.btn-metrics:hover{color:#fff;border-color:rgba(255,255,255,0.2);}.pulse-ring{width:12px;height:12px;background:#38bdf8;border-radius:50%;box-shadow:0 0 0 0 rgba(56,189,248,0.7);animation:pulse 1.6s infinite;margin:0 auto 12px;}@keyframes pulse{0%{transform:scale(0.95);box-shadow:0 0 0 0 rgba(56,189,248,0.7);}70%{transform:scale(1);box-shadow:0 0 0 10px rgba(56,189,248,0);}100%{transform:scale(0.95);box-shadow:0 0 0 0 rgba(56,189,248,0);}}.tabs{display:flex;gap:8px;margin-bottom:28px;}.tab-btn{background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);color:#94a3b8;padding:10px 20px;border-radius:12px;font-weight:700;cursor:pointer;transition:all 0.2s;font-size:14px;}.tab-btn:hover{background:rgba(255,255,255,0.1);color:#fff;}.tab-btn.active{background:linear-gradient(135deg,#38bdf8 0%,#818cf8 100%);color:#fff;border-color:transparent;box-shadow:0 4px 12px rgba(56,189,248,0.2);}.tab-content{display:none;}.tab-content.active{display:block;}.form-group{margin-bottom:20px;}label{display:block;font-size:11px;font-weight:600;text-transform:uppercase;color:#64748b;margin-bottom:8px;letter-spacing:0.05em;}input[type="text"],input[type="number"],select{width:100%;background:rgba(15,23,42,0.6);border:1px solid rgba(255,255,255,0.08);padding:12px 16px;border-radius:12px;color:#f8fafc;font-size:14px;transition:all 0.2s;box-sizing:border-box;}input:focus,select:focus{border-color:#38bdf8;outline:none;box-shadow:0 0 0 3px rgba(56,189,248,0.15);}.btn{background:linear-gradient(135deg,#38bdf8 0%,#818cf8 100%);color:#fff;border:none;padding:12px 24px;border-radius:12px;font-weight:700;cursor:pointer;transition:all 0.2s;box-shadow:0 4px 12px rgba(56,189,248,0.2);font-size:13px;display:inline-flex;align-items:center;justify-content:center;}.btn:hover{transform:translateY(-1px);opacity:0.95;}.btn:disabled{opacity:0.5;cursor:not-allowed;transform:none;}.btn-secondary{background:rgba(255,255,255,0.08);color:#fff;border:1px solid rgba(255,255,255,0.1);box-shadow:none;}.btn-secondary:hover{background:rgba(255,255,255,0.12);}.btn-danger{background:linear-gradient(135deg,#ef4444 0%,#dc2626 100%);box-shadow:0 4px 12px rgba(239,68,68,0.2);}.btn-success{background:linear-gradient(135deg,#10b981 0%,#059669 100%);box-shadow:0 4px 12px rgba(16,185,129,0.2);}.hidden{display:none !important;}.alert-notice{background:rgba(239,68,68,0.1);border:1px solid rgba(239,68,68,0.2);color:#fca5a5;padding:18px;border-radius:16px;margin-bottom:24px;font-size:13px;line-height:1.6;}.alert-notice a{color:#38bdf8;text-decoration:underline;font-weight:600;}.body-center{display:flex;align-items:center;justify-content:center;}.card-update{background:linear-gradient(145deg,rgba(30,41,59,0.5) 0%,rgba(15,23,42,0.75) 100%);backdrop-filter:blur(20px);border:1px solid rgba(255,255,255,0.05);border-radius:24px;padding:32px;width:100%;max-width:450px;box-shadow:0 20px 40px -15px rgba(0,0,0,0.5);text-align:center;}.card-update h3{font-size:20px;font-weight:800;margin-top:0;margin-bottom:24px;background:linear-gradient(135deg,#38bdf8 0%,#818cf8 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;}.card-update.error h3{background:linear-gradient(135deg,#ef4444 0%,#dc2626 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;}.card-update.success h3{background:linear-gradient(135deg,#10b981 0%,#059669 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;}.card-update p{color:#94a3b8;font-size:14px;margin-bottom:16px;}.file-input-wrapper{margin-bottom:24px;}input[type="file"]{display:none;}.custom-file-upload{display:inline-block;padding:12px 24px;background:rgba(15,23,42,0.6);border:1px dashed rgba(56,189,248,0.4);border-radius:12px;cursor:pointer;font-size:14px;color:#38bdf8;transition:all 0.2s;width:80%;}.custom-file-upload:hover{background:rgba(56,189,248,0.1);border-color:#38bdf8;}.btn-submit{background:linear-gradient(135deg,#38bdf8 0%,#818cf8 100%);border:none;color:#fff;padding:12px 28px;font-size:14px;font-weight:600;border-radius:12px;cursor:pointer;box-shadow:0 4px 12px rgba(56,189,248,0.2);transition:all 0.2s;}.btn-submit:hover{transform:translateY(-2px);box-shadow:0 6px 20px rgba(56,189,248,0.35);}.btn-submit:active{transform:translateY(0);}.file-name{margin-top:8px;font-size:12px;color:#64748b;}.btn-back{display:inline-block;margin-top:16px;font-size:13px;color:#64748b;text-decoration:none;transition:color 0.2s;}.btn-back:hover{color:#f8fafc;}.legend-card{margin-bottom:24px;background:rgba(17,24,39,0.3);border:1px solid rgba(255,255,255,0.04);border-radius:16px;padding:16px 20px;display:flex;flex-direction:column;gap:12px;}.legend-header{display:flex;align-items:center;gap:8px;font-size:12px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:0.05em;}.legend-icon{width:14px;height:14px;color:#94a3b8;}.legend-body{display:flex;flex-wrap:wrap;gap:24px;}.legend-section{display:flex;align-items:center;gap:12px;}.legend-section-title{font-size:11px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:0.02em;}.legend-indicators{display:flex;gap:12px;flex-wrap:wrap;}.legend-tag{display:flex;align-items:center;gap:6px;font-size:11px;font-weight:600;color:#94a3b8;padding:4px 10px;background:rgba(15,23,42,0.4);border-radius:8px;border:1px solid rgba(255,255,255,0.02);}.legend-dot{width:6px;height:6px;border-radius:50%;}.legend-tag.strong{border-color:rgba(16,185,129,0.15);}.legend-tag.strong .legend-dot{background:#10b981;}.legend-tag.medium{border-color:rgba(245,158,11,0.15);}.legend-tag.medium .legend-dot{background:#f59e0b;}.legend-tag.weak{border-color:rgba(239,68,68,0.15);}.legend-tag.weak .legend-dot{background:#ef4444;}.radar-container{position:relative;width:80px;height:80px;display:flex;align-items:center;justify-content:center;margin-bottom:8px;}.radar-icon{width:32px;height:32px;color:#38bdf8;z-index:2;filter:drop-shadow(0 0 8px rgba(56,189,248,0.5));}.radar-circle{position:absolute;top:50%;left:50%;width:100%;height:100%;border:1px solid rgba(56,189,248,0.25);border-radius:50%;transform:translate(-50%,-50%) scale(0.2);opacity:0;pointer-events:none;}.circle-1{animation:radar-pulse 3s infinite linear;}.circle-2{animation:radar-pulse 3s infinite 1s linear;}.circle-3{animation:radar-pulse 3s infinite 2s linear;}@keyframes radar-pulse{0%{transform:translate(-50%,-50%) scale(0.2);opacity:0.8;}100%{transform:translate(-50%,-50%) scale(1.2);opacity:0;}}.scanning-dots::after{content:'';animation:scanning-dots-anim 1.5s infinite;}@keyframes scanning-dots-anim{0%{content:'';}33%{content:'.';}66%{content:'..';}100%{content:'...';}}</style> </head><body><div class="container"><header><div><h1>Gateway Administration</h1><div style="font-size:12px; color:#64748b; margin-top:4px;">System configuration and node provisioning</div></div><div><a href="/metrics" class="btn-metrics">Prometheus Metrics</a><a href="/update" class="btn-update">Firmware Update</a><a href="/" class="btn" style="background:rgba(255, 255, 255, 0.08); border:1px solid rgba(255,255,255,0.1); margin-left:8px;">← Dashboard</a></div></header><div class="tabs"><button class="tab-btn active" id="tab-btn-gw-config" onclick="switchTab('gw-config')">Gateway Configuration</button><button class="tab-btn" id="tab-btn-ble" onclick="switchTab('ble')">Node Configuration (BLE)</button></div><div id="tab-gw-config" class="tab-content active"><div id="gw-ble-security-notice" class="alert-notice hidden"><strong>⚠️ Bluetooth disabled by browser (Security)</strong><br> The browser requires a secure connection (HTTPS or localhost) to allow Bluetooth.<br> To use local BLE, open this page locally (double-click) or access the local IP via HTTP. </div><div id="gw-ble-container" style="margin-bottom: 24px;"><div class="stat-card" style="padding: 24px;"><h2 style="margin-top:0; font-size: 18px; font-weight: 700;">Bluetooth Low Energy Connection (Gateway)</h2><p style="font-size: 13px; color: #94a3b8; margin-bottom: 16px;"> Put the gateway into config mode (press the BOOT button or start it without config; the blue LED will start flashing), then connect via local BLE below. </p><div style="display: flex; gap: 16px; align-items: center;"><button type="button" class="btn" id="btn-gw-connect">Connect to Gateway</button><div style="display: flex; align-items: center; gap: 8px; font-size: 14px;"><span id="gw-status-dot" class="dot offline"></span><span id="gw-status-text" style="font-weight:600; color:#ef4444;">Disconnected</span></div></div></div></div><form id="gw-config-form" class="hidden"><div class="grid" style="grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 24px; margin-bottom: 24px;"><div class="stat-card" style="padding: 24px;"><h3 style="margin-top:0; font-size: 15px; font-weight: 700; color: #38bdf8; border-bottom:1px solid rgba(255,255,255,0.05); padding-bottom:10px; margin-bottom:15px;">WiFi Network & Security</h3><div class="form-group"><label for="gw_wifi_ssid">Network Name (SSID)</label><input type="text" id="gw_wifi_ssid" required placeholder="e.g. MyWiFiNetwork"></div><div class="form-group"><label for="gw_wifi_pass">WiFi Password</label><input type="text" id="gw_wifi_pass" required placeholder="WPA Key"></div><div class="form-group" style="margin-top:24px; border-top:1px solid rgba(255,255,255,0.05); padding-top:16px;"><label for="gw_admin_pass">Administration Password (HTTP Auth)</label><input type="text" id="gw_admin_pass" required placeholder="admin" value="admin"><span style="font-size:10px; color:#64748b; display:block; margin-top:4px;">Default: admin</span></div></div><div class="stat-card" style="padding: 24px;"><h3 style="margin-top:0; font-size: 15px; font-weight: 700; color: #38bdf8; border-bottom:1px solid rgba(255,255,255,0.05); padding-bottom:10px; margin-bottom:15px;">IP Configuration</h3><div class="form-group" style="display: flex; align-items: center; gap: 10px; margin-bottom: 20px;"><input type="checkbox" id="gw_use_static" style="width:20px; height:20px; cursor:pointer;"><label for="gw_use_static" style="margin-bottom:0; cursor:pointer;">Use static IP address</label></div><div id="gw-static-ip-fields" style="display: none;"><div class="form-group"><label for="gw_local_ip">Local IP Address</label><input type="text" id="gw_local_ip" placeholder="e.g. 192.168.1.100"></div><div class="form-group"><label for="gw_gateway_ip">Default Gateway</label><input type="text" id="gw_gateway_ip" placeholder="e.g. 192.168.1.1"></div><div class="form-group"><label for="gw_subnet_mask">Subnet Mask</label><input type="text" id="gw_subnet_mask" placeholder="e.g. 255.255.255.0"></div></div></div><div class="stat-card" style="padding: 24px;"><h3 style="margin-top:0; font-size: 15px; font-weight: 700; color: #38bdf8; border-bottom:1px solid rgba(255,255,255,0.05); padding-bottom:10px; margin-bottom:15px;">LoRa Security (AES-GCM Encryption)</h3><div class="form-group"><label for="gw_aes_key">Shared AES Key (32 hex chars / 16 bytes)</label><input type="text" id="gw_aes_key" maxlength="32" minlength="32" required placeholder="Hexadecimal AES Key"></div><button type="button" class="btn btn-secondary" onclick="generateRandomGwKey()" style="width:100%; margin-top:8px;">Generate Random Key</button></div></div><div style="display: flex; gap: 16px; margin-top: 24px; border-top: 1px solid rgba(255,255,255,0.05); padding-top: 24px;"><input type="submit" value="Save Configuration" class="btn" style="flex: 1;"><button type="button" class="btn btn-danger" id="btn-gw-reset" style="padding: 12px 28px;">Factory Reset</button></div></form></div><div id="tab-ble" class="tab-content"><div id="ble-security-notice" class="alert-notice hidden"><strong>⚠️ Bluetooth disabled by browser (Security)</strong><br> The browser requires a secure connection (HTTPS or localhost) to allow Bluetooth.<br> To use local BLE, open this page locally (double-click) or access the local IP via HTTP. </div><div id="ble-container"><div class="stat-card" style="margin-bottom: 24px; padding: 24px;"><h2 style="margin-top:0; font-size: 18px; font-weight: 700;">Bluetooth Low Energy Connection (Node)</h2><p style="font-size: 13px; color: #94a3b8; margin-bottom: 16px;"> Put the LoRa node into configuration mode (by pressing the BOOT button once; the blue LED will start flashing), then connect below. </p><div style="display: flex; gap: 16px; align-items: center;"><button type="button" class="btn" id="btn-connect">Connect to Node</button><div style="display: flex; align-items: center; gap: 8px; font-size: 14px;"><span id="status-dot" class="dot offline"></span><span id="status-text" style="font-weight:600; color:#ef4444;">Disconnected</span></div></div></div><form id="config-form" class="hidden"><div class="grid" style="grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 24px; margin-bottom: 24px;"><div class="stat-card" style="padding: 24px;"><h3 style="margin-top:0; font-size: 15px; font-weight: 700; color: #38bdf8; border-bottom:1px solid rgba(255,255,255,0.05); padding-bottom:10px; margin-bottom:15px;">Node Identity</h3><div class="form-group"><label for="node_id">Unique Node ID</label><input type="number" id="node_id" min="1" max="254" required></div><div class="form-group"><label for="node_name">Node Name</label><input type="text" id="node_name" maxlength="15" placeholder="e.g. LivingRoom" required></div><div class="form-group"><label for="tx_interval">Transmission Interval (sec)</label><input type="number" id="tx_interval" min="5" max="3600" required></div></div><div class="stat-card" style="padding: 24px;"><h3 style="margin-top:0; font-size: 15px; font-weight: 700; color: #38bdf8; border-bottom:1px solid rgba(255,255,255,0.05); padding-bottom:10px; margin-bottom:15px;">LoRa Radio Settings</h3><div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;"><div class="form-group"><label for="lora_freq">Frequency (MHz)</label><input type="number" id="lora_freq" step="0.1" required></div><div class="form-group"><label for="lora_bw">Bandwidth (kHz)</label><select id="lora_bw" required><option value="7.8">7.8</option><option value="10.4">10.4</option><option value="15.6">15.6</option><option value="20.8">20.8</option><option value="31.25">31.25</option><option value="41.7">41.7</option><option value="62.5">62.5</option><option value="125.0">125.0</option><option value="250.0">250.0</option><option value="500.0">500.0</option></select></div></div><div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;"><div class="form-group"><label for="lora_sf">Spreading Factor (SF)</label><input type="number" id="lora_sf" min="6" max="12" required></div><div class="form-group"><label for="lora_cr">Coding Rate (CR)</label><input type="number" id="lora_cr" min="5" max="8" required></div></div><div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;"><div class="form-group"><label for="lora_sync">Sync Word (Hex)</label><input type="text" id="lora_sync" required></div><div class="form-group"><label for="lora_power">TX Power (dBm)</label><input type="number" id="lora_power" min="2" max="20" required></div></div><div class="form-group"><label for="lora_preamble">LoRa Preamble</label><input type="number" id="lora_preamble" min="6" max="65535" required></div></div><div class="stat-card" style="padding: 24px;"><h3 style="margin-top:0; font-size: 15px; font-weight: 700; color: #38bdf8; border-bottom:1px solid rgba(255,255,255,0.05); padding-bottom:10px; margin-bottom:15px;">Node Security & Update</h3><div class="form-group"><label for="aes_key">Shared AES Key (32 hex chars / 16 bytes)</label><input type="text" id="aes_key" maxlength="32" minlength="32" required placeholder="AES Encryption Key"></div><button type="button" class="btn btn-secondary" onclick="generateRandomKey()" style="width:100%; margin-bottom: 20px;">Generate Random Key</button><div style="border-top: 1px solid rgba(255,255,255,0.05); padding-top: 16px;"><h4 style="margin-top:0; font-size: 13px; color:#f8fafc; font-weight:700;">Node OTA Update</h4><div class="form-group" style="margin-top:12px;"><label for="ota-file" class="custom-file-upload" style="text-align:center;">Choose firmware (.bin)</label><input type="file" id="ota-file" accept=".bin"><div id="ota-file-name" class="file-name">No file selected</div></div><button type="button" class="btn btn-success" id="btn-start-ota" style="display:none; width:100%; margin-top:8px;">Start OTA Update</button><div id="ota-progress-container" style="display:none; margin-top: 16px;"><div style="display:flex; justify-content:space-between; font-size:12px; margin-bottom:6px;"><span id="ota-status-label" style="color:#94a3b8;">Uploading file...</span><span id="ota-percent" style="font-weight:700; color:#38bdf8;">0%</span></div><div style="background:rgba(0,0,0,0.3); border-radius:10px; height:8px; overflow:hidden;"><div id="ota-bar" style="background:linear-gradient(90deg, #38bdf8, #818cf8); width:0%; height:100%; transition:width 0.1s;"></div></div></div></div></div></div><div style="display: flex; gap: 16px; margin-top: 24px; border-top: 1px solid rgba(255,255,255,0.05); padding-top: 24px;"><input type="submit" value="Save Node Configuration" class="btn" style="flex: 1;"><button type="button" class="btn btn-danger" id="btn-reset" style="padding: 12px 28px;">Factory Reset Node</button></div></form></div></div></div> <script>class NimBLEDataPipe {
